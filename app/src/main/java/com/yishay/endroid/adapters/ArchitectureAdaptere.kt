...
import com.yishay.endroid.ArchitectureFragmentDirections
...
class ArchitectureAdaptere(val context: Context, private val tutorials: List<Tutorials>) :
    RecyclerView.Adapter<ArchitectureAdaptere.MyViewHolder>() {
            ...
            itemView.setOnClickListener {
                currentTutorial?.let {
                    itemView.setOnClickListener {
                        ...
                        val action =
                            ArchitectureFragmentDirections.actionArchitectureFragmentToOrientedFragment(
                                currentPosition, "architecture"
                            )
