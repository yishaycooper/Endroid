...
import com.yishay.endroid.TutorialsFragmentDirections
import com.yishay.endroid.model.Tutorials
import kotlinx.android.synthetic.main.tutorial_item.view.*


class TutorialsAdapter(val context: Context, private val tutorials: List<Tutorials>) :
            ...
            itemView.setOnClickListener {
                currentTutorial?.let {
                    itemView.setOnClickListener {
                        ...
                        val action =
                            TutorialsFragmentDirections.actionTutorialsFragmentToOrientedFragment(
                                currentPosition, "tutorial"
                            )
