...
import com.yishay.endroid.ExamplesFragmentDirections
...
class ExamplesTutorialsAdapter(val context: Context, private val tutorials: List<Tutorials>) :
    RecyclerView.Adapter<ExamplesTutorialsAdapter.MyViewHolder>() {
            ...
            itemView.setOnClickListener {
                currentTutorial?.let {
                    itemView.setOnClickListener {
                        ...
                        val action =
                            ExamplesFragmentDirections.actionExamplesFragmentToBottomTabActivity(
                                currentPosition
                            )
