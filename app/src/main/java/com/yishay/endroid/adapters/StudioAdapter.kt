...
import com.yishay.endroid.StudioFragmentDirections
import com.yishay.endroid.model.Tutorials
import kotlinx.android.synthetic.main.tutorial_item.view.*


class StudioAdapter(val context: Context, private val tutorials: List<Tutorials>) :
    RecyclerView.Adapter<StudioAdapter.MyViewHolder>() {
            ...
            itemView.setOnClickListener {
                currentTutorial?.let {
                    itemView.setOnClickListener {
                        ...
                        val action =
                            StudioFragmentDirections.actionStudioFragmentToOrientedFragment(
                                currentPosition, "androidStudio"
                            )
